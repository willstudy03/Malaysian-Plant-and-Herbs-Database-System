...
if (isset($_GET['id'])) {
    $id = $_GET['id'];
    $plant = getPlant($id);
    $cName = $plant['commonName'];
    $sName = $plant['scientificName'];
    $stock = $plant['stock'];
    $price = $plant['price'];
}
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (!$error) {
        setPlant($id, $cName, $sName, $stock, $price);
...
<body>
    ...
    <div class="container my-5">
            <h2> Edit Plant <i class="ri-plant-fill"></i></h2>
    </div>
    ...
    <div class="container bigContainer">
        <div class="formContainer">
            <h2>Edit Plant</h2>
            <span>Please fill in the required information to modify the plant or herb.</span>
            <form method="post" id="newPlantForm">
                <h5>Plant Name</h5>
                <input type="text" name="cName" id="cName" placeholder=<?=$cName?> value=<?=$cName?>>
                <span id="cnameError" class="text-danger"><?=$cNameError?></span>
                <input type="text" name="sName" id="sName" placeholder=<?=$sName?> value=<?=$sName?>>
                <span id="snameError" class="text-danger"><?$sNameError?></span>
                <h5>Stock</h5>
                <input type="text" name="stock" id="stock" placeholder=<?=$stock?> value=<?=$stock?>>
                ...
                <button id="addBtn" type="submit">confirm</button>
